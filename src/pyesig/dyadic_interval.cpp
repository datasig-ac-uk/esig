...
void esig::python::init_dyadic_interval(py::module_ &m) {
    ...
    klass.def_static(
        "to_dyadic_intervals",
        [](const esig::interval &domain, power_t resolution, esig::interval_type itype) { return esig::to_dyadic_intervals(domain.inf(), domain.sup(), resolution, itype); },

...
//    friend class ::esig::algebra::algebra_implementation_access<lie_implementation, Impl>;
//
...
//    void add_inplace(const lie_interface &other) override;
//    void sub_inplace(const lie_interface &other) override;
//    void smul_inplace(const coefficient &other) override;
//    void sdiv_inplace(const coefficient &other) override;
//    void mul_inplace(const lie_interface &other) override;
//    void add_scal_mul(const lie_interface &other, const coefficient &scal) override;
//    void sub_scal_mul(const lie_interface &other, const coefficient &scal) override;
//    void add_scal_div(const lie_interface &other, const coefficient &scal) override;
//    void sub_scal_div(const lie_interface &other, const coefficient &scal) override;
//    void add_mul(const lie_interface &lhs, const lie_interface &rhs) override;
//    void sub_mul(const lie_interface &lhs, const lie_interface &rhs) override;
//    void mul_smul(const lie_interface &other, const coefficient &scal) override;
//    void mul_sdiv(const lie_interface &other, const coefficient &scal) override;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::add_inplace(const lie_interface &other)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
//    m_data += o_data;
//    return *this;
//}
//template<typename Impl>
//void lie_implementation<Impl>::sub_inplace(const lie_interface &other)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
//    m_data -= o_data;
//    return *this;
//}
//template<typename Impl>
//void lie_implementation<Impl>::smul_inplace(const coefficient &other)
//{
//    m_data *= coefficient_cast<scalar_type>(other);
//    return *this;
//}
//template<typename Impl>
//void lie_implementation<Impl>::sdiv_inplace(const coefficient &other)
//{
//    m_data /= coefficient_cast<scalar_type>(other);
//    return *this;
//}
//template<typename Impl>
//void lie_implementation<Impl>::mul_inplace(const lie_interface &other)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
//    m_data *= o_data;
//    return *this;
//}
//template<typename Impl>
//void lie_implementation<Impl>::add_scal_mul(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::sub_scal_mul(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::add_scal_div(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::sub_scal_div(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::add_mul(const lie_interface &lhs, const lie_interface &rhs)
//{
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::sub_mul(const lie_interface &lhs, const lie_interface &rhs)
//{
//    auto lhs_data = dynamic_cast<const lie_implementation &>(lhs).m_data;
//    auto rhs_data = dynamic_cast<const lie_implementation &>(rhs).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::mul_smul(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
...
//}
//template<typename Impl>
//void lie_implementation<Impl>::mul_sdiv(const lie_interface &other, const coefficient &scal)
//{
//    auto o_data = dynamic_cast<const lie_implementation &>(other).m_data;
//    m_data.sub_scal_div(o_data, coefficient_cast<scalar_type>(scal));
//    return *this;

...
def test ():
   ...
   # else:
   #    print("test 1 passed")
   assert len(selected_points) <= dimension + 1 and (normalised_error <= 1e-13)
   ...
   # else:
   #    print("test 2 passed")
   assert (len(selected_points) <= dimension + 1) and (normalised_error <= 1e-12)
   ...
   # else:
   #    print("test 3 passed")
   assert (normalised_error_in_mean <= 1e-13) and (normalised_error_in_cov <= 1e-13)
